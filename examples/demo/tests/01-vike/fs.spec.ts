...
describe("fs", () => {
  ...
  const expected = [
    ...
    "/config.json",
    // functions: edge
    "/functions/__vike/pages/vike-edge.func/.vc-config.json",
    "/functions/__vike/pages/vike-edge.func/index.js",
    // functions: node
    "/functions/__vike/pages/catch-all.prerender-config.json",
    "/functions/__vike/pages/catch-all.func/index.mjs",
    "/functions/__vike/pages/catch-all.func/.vc-config.json",
    "/functions/__vike/pages/isr.prerender-config.json",
    "/functions/__vike/pages/isr.func/index.mjs",
    "/functions/__vike/pages/isr.func/.vc-config.json",
    "/functions/__vike/pages/named.prerender-config.json",
    "/functions/__vike/pages/named.func/index.mjs",
    "/functions/__vike/pages/named.func/.vc-config.json",
    "/functions/__vike/__catch_all.func/index.mjs",
